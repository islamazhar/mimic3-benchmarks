...
class BatchGen(object):
    ...
    def __init__(self, reader, discretizer, normalizer,
                 batch_size, steps, shuffle, return_names=False, class_0_weight = 1, class_1_weight = 1):
        self.reader = reader
            ...
            while remaining > 0:
                ...
                for i in range(0, current_size, B):
                    ...
                    if not self.return_names:
                        yield batch_data # yield is a return statement https://www.geeksforgeeks.org/use-yield-keyword-instead-return-keyword-python/
                    else:
